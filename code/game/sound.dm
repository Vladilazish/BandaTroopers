...
/proc/get_sfx(sound)
	if(istext(sound))
		switch(sound)
			...
			if("gurgle")
				sound = pick('sound/effects/gurgle1.ogg', 'sound/effects/gurgle2.ogg', 'sound/effects/gurgle3.ogg', 'sound/effects/gurgle4.ogg')
			// Weapons/bullets
			if("shell_load")
			...
			if("vp70")
				sound = pick('sound/weapons/gun_vp70_v7.ogg')
			...
			// SS220 EDIT - START: HALO sfx keys
			// HALO guns UNSC
			if("gun_ma5c")
			...
			if("gun_br55")
				sound = pick('sound/weapons/halo/gun_br55_1.ogg','sound/weapons/halo/gun_br55_2.ogg','sound/weapons/halo/gun_br55_3.ogg','sound/weapons/halo/gun_br55_4.ogg')
			if("gun_m90")
