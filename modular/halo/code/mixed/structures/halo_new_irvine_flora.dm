...
/obj/structure/flora/forest/small_tree
	name = "spindly tree"
	icon = 'modular/halo/icons/obj/flora/new_irvine_small_tree.dmi'
...
/obj/structure/flora/forest/bush
	name = "bushes"
	icon = 'modular/halo/icons/obj/flora/new_irvine_forest_64x64.dmi'
...
/obj/structure/flora/forest/pines
	name = "pine tree"
	icon = 'modular/halo/icons/obj/flora/new_irvine_pines.dmi'
